...
from agent.src.genner import Genner  # adjust this import if necessary
...
class MockGenner(Genner):
	...
	def generate(self, prompt: str) -> str:
		...
		mock_json_response = '''[
			{
				"game_id": "0x3230323530383238353738423236424100000000000000000000000000000000",
				"home_team": "Rutgers",
				"away_team": "Ohio",
				"decision": "Bet on Home Team",
				"bet_amount": 0.1,
				"justification": "Rutgers has strong home advantage and favorable odds"
			}
		]'''
