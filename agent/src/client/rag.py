...
class RAGClient:
	...
	def query_documents(self, query_text: str):
		...
		This is a simplified query that uses the relevant_strategy_raw_v4 endpoint.
	...
	def update_document(self, document_id: str, document: dict):
		...
		This is a simplified update that uses the save_result endpoint.
		
		Args:
			document_id (str): The ID of the document to update
			document (dict): The updated document data
		...
		payload = {
			...
			"strategy_data": json.dumps(document),
