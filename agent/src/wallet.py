...
from agent.src.datatypes import WalletStats
from dotenv import load_dotenv
from agent.src.db import SQLiteDB

load_dotenv()

# Don't create DB instance during import - will be created when needed
def get_db_instance():
    return SQLiteDB(db_path=os.getenv("SQLITE_PATH", "/app/agent/db/superior-agents.db"))
