...
def main():
    print("--- 🏆 POSTMAN FINALE CORRECTED: Starting Definitive On-Chain USDC Betting PoC on ARBITRUM ---")
    load_dotenv()

    # --- Load all necessary variables with CORRECT Sports AMM address ---
    ...
    # CORRECT Sports AMM address from verified transactions
